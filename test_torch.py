...
# - 操作系统: Windows 10
# - Python版本: 3.10.16
# - 解释器路径: D:\miniconda3\envs\disprot\python.exe
# - 工作目录: D:\Documents\GitHub\disport
# ==================================================
# PyTorch测试:
# ✓ PyTorch版本: 2.4.0+cpu
# - PyTorch路径: D:\miniconda3\envs\disprot\lib\site-packages\torch\__init__.py
# ❌ CUDA不可用
# ✓ 基本张量操作成功
# ==================================================
# DLL文件检查:
